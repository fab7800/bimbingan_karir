            ...
            <div class="overflow-x-auto rounded-box bg-white p-5 shadow-xs">
                <table class="table">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th class="w-1/3">Kategori Tiket</th>
                            <th>Harga</th>
                            <th>Stok</th>
                            <th>Aksi</th>
                        </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-primary mr-2" onclick="openEditModal(this)"
                                        data-id="{{ $ticket->id }}"
                                        data-kategori="{{ $ticket->tickets_kategory_id }}"
    ...
    <dialog id="add_ticket_modal" class="modal">
        <form method="POST" action="{{ route('admin.tickets.store') }}" class="modal-box">
            ...
            <div class="form-control mb-4">
                ...
                <select name="tickets_kategory_id" class="select select-bordered w-full" required>
                    <option value="" disabled selected>Pilih Kategori Ticket</option>
                    @foreach ($ticketKategories as $kategori)
    ...
    <dialog id="edit_ticket_modal" class="modal">
        <form method="POST" class="modal-box">
            ...
            <div class="form-control mb-4">
                ...
                <select name="tickets_kategory_id" id="edit_kategori" class="select select-bordered w-full" required>
                    @foreach ($ticketKategories as $kategori)
                        <option value="{{ $kategori->id }}">
                            {{ $kategori->nama }}
                        </option>

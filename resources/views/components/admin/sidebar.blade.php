<div class="drawer-side is-drawer-close:overflow-visible ">
    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 w-64 is-drawer-close:w-14 is-drawer-open:w-80">
        <div class="w-full flex items-center justify-center p-4">
            <img src="{{ asset('assets/images/logo_bengkod.jpg') }}" alt="Logo">
        </div>
        ...
        <ul class="menu w-full grow gap-1">
            ...
            <!-- Kategori Tiket item -->
            <li class="{{ request()->routeIs('admin.ticket-kategories.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('admin.ticket-kategories.index') }}"
                class="is-drawer-close:tooltip is-drawer-close:tooltip-right"
                data-tip="Kategori Tiket">
                    <!-- icon ticket -->
                    ...
                    <span class="is-drawer-close:hidden">Kategori Tiket</span>
                </a>
            </li>
